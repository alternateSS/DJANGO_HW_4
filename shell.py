...
# order_1 = food_1.orders.set([ingredients_3, ingredients_1, ingredients_4, ingredients_5], through_defaults={'client':client, 'worker':worker})
order_1 = FoodCounter.objects.create(food=food_1, ingredient=ingredients_6, client=client, worker=worker)
order_1.save()
